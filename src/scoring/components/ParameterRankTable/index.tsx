...
const PARAMETER_DETAILS = [
  ...
  },
  {
    ...
    ranks: [
      ...
      { rank: 'VII', threshold: 'Over 1000 damage', points: 1000 },
      // { rank: 'VI', threshold: 'Over 450 damage', points: 750 },
      { rank: 'VI', threshold: '???', points: 750 },
      { rank: 'V', threshold: 'Over 200 damage', points: 750 },
      ...
      { rank: 'I', threshold: 'Over 10 damage', points: 100 },
    ],
  },
  {
  ...
  },
  {
    ...
    ranks: [
      { rank: 'IX', threshold: 'Under 3 turns', points: 500 },
      { rank: 'VIII', threshold: 'Under 4 turns', points: 450 },
      { rank: 'VII', threshold: 'Under 5 turns', points: 400 },
      { rank: 'VI', threshold: 'Under 6 turns', points: 300 },
      { rank: 'V', threshold: 'Under 7 turns', points: 250 },
      { rank: 'IV', threshold: 'Under 8 turns', points: 200 },
      { rank: 'III', threshold: 'Under 9 turns', points: 150 },
      { rank: 'II', threshold: 'Under 10 turns', points: 100 },
      { rank: 'I', threshold: 'Under 11 turns', points: 50 },
    ],
  },
  {
    ...
    ranks: [
      { rank: 'IX', threshold: 'Over 99 cards', points: 2000 },
      { rank: 'VIII', threshold: 'Over 79 cards', points: 1750 },
      { rank: 'VII', threshold: 'Over 59 cards', points: 1500 },
      { rank: 'VI', threshold: 'Over 44 cards', points: 1000 },
      { rank: 'V', threshold: 'Over 29 cards', points: 750 },
      { rank: 'IV', threshold: 'Over 19 cards', points: 500 },
      { rank: 'III', threshold: 'Over 9 cards', points: 250 },
      { rank: 'II', threshold: 'Over 4 cards', points: 50 },
      { rank: 'I', threshold: 'Over 2 cards', points: 25 },
    ],
  },
  {
    id: 'wealth' as const,
    ...
    ranks: [
      ...
      { rank: 'II', threshold: 'Over 125 total', points: 200 },
      { rank: 'I', threshold: 'Over 50 total', points: 100 },
    ],
    ranksSunforge: [
