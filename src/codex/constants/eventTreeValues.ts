...
export const TREE = {
  ...
  VERTICAL_PADDING_BY_LEVEL_OF_DETAIL: {
    [LevelOfDetail.COMPACT]: 35,
    [LevelOfDetail.BALANCED]: 45,
    [LevelOfDetail.WALL_OF_TEXT]: 45,
  },
...
export const INNER_BOX = {
  ...
  // Gap between main node text and Effects
  LISTINGS_TOP_MARGIN: 8,

  // Gap between Requirements and main node text
  LISTINGS_BOTTOM_MARGIN: 2,
