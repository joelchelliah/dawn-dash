...
export const PirateParlourImageUrl = `${blightbaneImagesUrl}/icons/Pirate%20Parlour_eclypse.webp`
export const RingOfPowerImageUrl = `${blightbaneImagesUrl}/icons/creature_abilties_4_2.webp`
...
export const ShovelImageUrl = `${blightbaneImagesUrl}/icons/Shovel.webp`
export const SongOfSlaughterImageUrl = `${blightbaneImagesUrl}/icons/cards_metamorphosis_2_13.webp`
export const SongOfSagesImageUrl = `${blightbaneImagesUrl}/icons/card_unlocks_31.webp`
